...
export const tvgCreativePageData = [
  {
    id: "hero",
    headline: "Agency Management Services for Court Reporting Firms",
    subHeading: "TVG Management",
    description:
  ...
  },
  {
    id: "overview",
    headline:
      "Proven Experience Delivering the Efficiency You Need",
    description:[
    ...
    image: "./services/management-over.png",
  },
  {
    id: "provide",
    headline: "Shaping the Future",
    description: "We manage your back office so you can focus on delivering top-tier client service. From scheduling to payroll, we streamline the chaos behind the scenes.",
    tagsLeft: [
  ...
  },
  {
    ...
    description: "Every business needs structure and we’re here to build it with you. We streamline operations, reduce stress, and let you focus on what matters most the growth.",
    cards: [
      {
        title: "24+",
      ...
      {
        title: "98%",
        desc: "Positive Client Feedback",
      },
      {
        title: "1000+",
        desc: "Attorneys Supported Annually",
      },
    ],
  },
  {
